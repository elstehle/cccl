...
// Pointer overload: round-trip through the 64-bit broadcast so a pointer-typed
// warp-uniform value (per-segment counter / histogram / buffer base /
// dereferenced raw-pointer iterator) becomes eligible for ptxas's R2UR
