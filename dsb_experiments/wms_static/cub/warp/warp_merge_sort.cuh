...
//!   <b>[optional]</b> Algorithm used for the Merge Path diagonal-intersection
//!   search (default: cub::MERGE_SORT_SEARCH_DYNAMIC)
//!
...
class WarpMergeSort
    : public BlockMergeSortStrategy<
        ...
        ITEMS_PER_THREAD,
        WarpMergeSort<KeyT, ITEMS_PER_THREAD, LOGICAL_WARP_THREADS, ValueT, SearchAlgorithm>,
        SearchAlgorithm>
{
private:
  ...
  using BlockMergeSortStrategyT =
    BlockMergeSortStrategy<KeyT, ValueT, LOGICAL_WARP_THREADS, ITEMS_PER_THREAD, WarpMergeSort, SearchAlgorithm>;
